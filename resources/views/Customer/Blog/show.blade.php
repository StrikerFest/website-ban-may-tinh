    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-row">
            ...
            <div class="container-fluid" style="padding-top: 70px">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <h1 class="text-center">{{ $baiViet->tenBV }}</h1>
                ...
                @foreach ($listNoiDung as $LND)
                    {{-- Tiêu đề --}}

                    <div class="row " style="padding-top: 5%; justify-content: center; word-break: break-word;color: black">
                        <div class="md-col-12" ">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center" style="width:100%">
                            @if($LND->anh == null)
                            @else
                            <img style="height: 500px;width:50%;" src="{{ asset('assets/img/' . $LND->anh) }}"
                                class="w-20 rounded bg-danger p-1" alt="Thumbnail">
                            @endif
                        </div>
                    </div>
                    {{-- Hết - Hình ảnh --}}
                    ...
                    {{-- Nội dung --}}
                    <div class="row " style="padding-top: 5%;  word-break: break-word">
                        <div class="md-col-12" style="padding: 0px 5%;color: black">
                            <p style="font-size: 1.2rem;text-justify: distribute-all-lines">
                                <?php
                                echo nl2br($LND->noiDung);
                                ?>
                            </p>
                        </div>
                                                ...
                                                <div class="media-body">
                                                    @foreach ($blogCommentMain as $BCM)
                                                        @if ($BCM->maBV == $baiViet->maBV)
                                                            ...
                                                            @endforeach
                                                            {{-- Form gửi phản hồi --}}
                                                            <form action="{{ route('blogCommentCustomer.store') }}"
                                                                method="POST" style="padding-left:8%">
                                                                @csrf
                                                                <input type="hidden" name="maNDBinhLuan"
                                                                    value="{{ session()->get('khachHang') }}">
                                                                <input type="hidden" name="maBVBinhLuan"
                                                                    value="{{ $baiViet->maBV }}">
