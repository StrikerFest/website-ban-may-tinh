...
use App\Http\Controllers\AdminBlogContentController;
...
Route::group(['prefix' => 'admin', 'middleware' => 'CheckLogin'], function () {
    ...
    Route::post('blogStoreContent/{maBV}', [AdminBlogController::class, "storeContent"])->name('blog.storeContent');
    Route::get('blogEditContent/{maNDBV}', [AdminBlogController::class, "editContent"])->name('blog.editContent');
    Route::put('blogUpdateContent/{maNDBV}', [AdminBlogController::class, "updateContent"])->name('blog.updateContent');
    Route::delete('blogDeleteContent/{maNDBV}', [AdminBlogController::class, "deleteContent"])->name('blog.deleteContent');
    ...
    Route::put('receiptCacncel/{maHD}', [AdminReceiptController::class, "cancelOrder"])->name('receipt.cancelOrder');
